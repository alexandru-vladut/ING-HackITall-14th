                                            ...
                                            Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    (thisMonthPoints != -1) ? thisMonthPoints.toString() : '',
                                                    textAlign: TextAlign.center,
                                                ...
                                                Padding(
                                                  padding:
                                                      const EdgeInsets.only(
                                                          left: 4, bottom: 3),
                                                  child: Text(
                                                    (userData != null) ? userData!.totalPoints.toString() : '',
                                                    textAlign: TextAlign.center,
                                                    style: const TextStyle(
                                                      fontFamily:
                                                          FitnessAppTheme
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    (userData != null) ? '${(userData!.totalPoints * 2.518).toStringAsFixed(1)} kg' : '',
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      fontFamily: FitnessAppTheme.fontName,
                                ...
                                Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        (userRank != 0) ?
                                          (userRank % 10 == 1) ? '${userRank}st' :
                                          (userRank % 10 == 2) ? '${userRank}nd' :
                                          (userRank % 10 == 3) ? '${userRank}rd' :
                                          '${userRank}th' : '',
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                                          fontFamily: FitnessAppTheme.fontName,
