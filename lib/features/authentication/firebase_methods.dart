...
void signUserInWithoutEmailVerification(BuildContext context, String email, String password) async {
...
void signUserInWithoutEmailVerificationAndPin(BuildContext context, String email, String password) async {
...
void signUserUpWithoutEmailVerification(BuildContext context, String inputEmail, String inputName, String inputPassword, String inputConfirmPassword) async {
  ...
  try {
    ...
    if (inputPassword == inputConfirmPassword) {
      ...
      Navigator.of(context).pushAndRemoveUntil(SlideRightToLeft(page: CreatePin(email: inputEmail, password: inputPassword)), (Route<dynamic> route) => false);
...
void signUserUpWithoutEmailVerificationAndPin(BuildContext context, String inputEmail, String inputName, String inputPassword, String inputConfirmPassword) async {
